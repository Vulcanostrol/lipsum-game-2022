...
public class Bullet extends Collidable implements Traversable {
    ...
    public Bullet(float x, float y, float xVelocity, float yVelocity, float damage, float bulletSize, float explosionSize) {
    ...
    private void tryDamageEntity(Damageable entity) {
        ...
        if (this.explosionSize > 0) {
            new Explosion(getX(), getY() - explosionSize / 2f, explosionSize, explosionSize, explosionSize, explosionSize, damage, damagePlayer, 75);
        }
